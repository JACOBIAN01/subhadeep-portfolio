  ...
  return (
    <div className="sticky top-0 z-50">
      <div className="mx-auto max-w-7xl px-4">
        <div className="mt-4 mb-4 rounded-2xl border border-white/10 bg-white/10 backdrop-blur-xl px-4 py-3 flex items-center justify-between shadow-xl">
          <a href="#home" className="font-semibold tracking-tight">
            <span className="text-white/80">Subhadeep</span>
