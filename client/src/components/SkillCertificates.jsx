...
function SkillCertCard({ cert }) {
  return (
    <div className="shrink-0 w-80 md:w-100 bg-white border border-hairline rounded-3xl overflow-hidden transition-[transform,box-shadow] duration-500 hover:-translate-y-1 hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)]">
